...
comments: true
share-description: "Segmenting UK online-retail customers with RFM scores and K-means, landing on 6 clusters after an elbow-method check."
---
...
#### 3. Divide the dataset into numeric data and categorical data.
