...
Understanding the data types within the dataset is vital process. Here, we categorize columns into numeric and categorical types.
   ...
   <img src="../assets/img/commerce/eda2.png" alt="data" width="200"/>
...
<div style="text-align:center;">
   <img src="../assets/img/commerce/InvoiceNo.png" alt="data" width="600"/>
</div>
   ...
   <div style="text-align:center;">
      <img src="../assets/img/commerce/output1-2.png" alt="data" width="600"/>
   </div>
